...
class ContactType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __mu = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'mu'), 'mu',
                                             '__AbsentNamespace0_ContactType_mu', pyxb.binding.datatypes.double,
                                             unicode_default='0')
    __mu._DeclarationLocation = pyxb.utils.utility.Location('/Users/ulbrich/Projects/RobotDesigner/resources/urdf.xsd',
                                                            106, 4)
    ...
    __kp = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'kp'), 'kp',
                                             '__AbsentNamespace0_ContactType_kp', pyxb.binding.datatypes.double,
                                             unicode_default='0')
    __kp._DeclarationLocation = pyxb.utils.utility.Location('/Users/ulbrich/Projects/RobotDesigner/resources/urdf.xsd',
                                                            107, 4)
    ...
    __kd = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'kd'), 'kd',
                                             '__AbsentNamespace0_ContactType_kd', pyxb.binding.datatypes.double,
                                             unicode_default='0')
    __kd._DeclarationLocation = pyxb.utils.utility.Location('/Users/ulbrich/Projects/RobotDesigner/resources/urdf.xsd',
                                                            108, 4)
