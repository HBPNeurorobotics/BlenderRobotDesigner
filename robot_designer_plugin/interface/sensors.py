...
def draw(layout, context):
    ...
    row = sensorbox.row()
    row.prop(bpy.data.objects[global_properties.active_sensor.get(context.scene)].RobotDesigner, 'sensor_type', text= "Sensor type")
    ...
    if tag == 'SENSOR':
        ...
        if box:
            ...
            if sensor_type == "CAMERA_SENSOR":
                    ...
                    row = box.row()
                    column = row.column(align=True)
                    column.prop(sensor.RobotDesigner.camera, 'width', text='width (px.)')
                    column = row.column(align=True)
                    column.prop(sensor.RobotDesigner.camera, 'height', text="height (px.)")
                    row = box.row()
                    column = row.column(align=True)
                    ...
                    row = box.row()
                    row.prop(sensor.RobotDesigner.camera, 'format', text="Format")
                    ...
                    column.prop(bpy.context.active_object.RobotDesigner.forceTorqueSensor, 'measure_direction', text='measure direction')
                    ...
                    column = row.column(align=True)
                    column.prop(bpy.context.active_object.RobotDesigner.laserSensor, 'horizontal_samples', text='Horizontal Samples')
                    column.prop(bpy.context.active_object.RobotDesigner.laserSensor, 'vertical_samples', text='Vertical Samples')
