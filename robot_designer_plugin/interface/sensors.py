    ...
    if tag == "SENSOR":
        ...
        if box:
            ...
            if sensor_type == "CAMERA_SENSOR":
                ...
                column = row.column(align=True)
                column.prop(
                    sensor.RobotDesigner.cameraSensor, "width", text="Width (px.)"
                )
                column = row.column(align=True)
                column.prop(
                    sensor.RobotDesigner.cameraSensor, "height", text="Height (px.)"
                )
                row = box.row()
                column = row.column(align=True)
                ...
                row.prop(
                    sensor.RobotDesigner.cameraSensor.noise, "stddev", text="Stddev"
                )
