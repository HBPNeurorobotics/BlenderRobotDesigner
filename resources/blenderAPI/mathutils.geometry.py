...
def intersect_plane_plane(plane_a_co, plane_a_no, plane_b_co, plane_b_no):
   '''Return the intersection between two planes
      ...
      @returns (tuple pair of mathutils.Vector): The line of the intersection represented as a point and a vector
   '''

   return tuple pair of mathutils.Vector
...
def points_in_planes(planes):
   '''Returns a list of points inside all planes given and a list of index values for the planes used.
      ...
      @returns (pair of lists): two lists, once containing the vertices inside the planes, another containing the plane indicies used
   '''
